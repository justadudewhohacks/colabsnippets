...
class FPN3Stage_64_128_256(FPN3StageBase):
  def __init__(self, name='fpn3stage_64_128_256', with_detection_module=True, use_minimal_anchors=True):
    super().__init__(name=name, stage_filters=[64, 128, 256],
                     with_detection_module=with_detection_module, use_minimal_anchors=use_minimal_anchors)
  ...
  def init_bottom_up_weights(self, weight_processor):
    ...
    weight_processor.process_main_block_weights(64, 'main_block_1_0')
    weight_processor.process_main_block_weights(64, 'main_block_1_1')
    weight_processor.process_main_block_weights(64, 'main_block_1_2')
    weight_processor.process_reduction_block_weights(64, 128, 'reduction_block_2')
    weight_processor.process_main_block_weights(128, 'main_block_2_0')
    weight_processor.process_main_block_weights(128, 'main_block_2_1')
    weight_processor.process_main_block_weights(128, 'main_block_2_2')
    ...
    weight_processor.process_main_block_weights(256, 'main_block_3_1')
    weight_processor.process_main_block_weights(256, 'main_block_3_2')
  ...
  def bottom_up(self, x):
    ...
    t_1_0 = out = depthwise_separable_conv2d(tf.nn.relu(out), 'separable_conv1', [1, 1, 1, 1])
