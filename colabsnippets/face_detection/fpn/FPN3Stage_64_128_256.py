...
class FPN3Stage_64_128_256(FPN3StageBase):
  def __init__(self, name = 'fpn3stage_64_128_256', with_detection_module = True):
    super().__init__(name = name, stage_filters = [64, 128, 256], with_detection_module = with_detection_module)
