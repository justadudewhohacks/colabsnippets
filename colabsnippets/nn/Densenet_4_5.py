...
class Densenet_4_5(Densenet_4_5_FeatureExtractor):
  def __init__(self, use_depthwise_separable_conv2d = True, with_batch_norm = False, name = 'densenet_4_5', channel_multiplier = 1.0):
    super().__init__(
  ...
  def initialize_weights(self, weight_processor):
    ...
    with tf.variable_scope(self.name):
      with tf.variable_scope('classifier'):
        ...
        weight_processor.process_fc_weights(c0 * 16, 1, 'fc_age')
