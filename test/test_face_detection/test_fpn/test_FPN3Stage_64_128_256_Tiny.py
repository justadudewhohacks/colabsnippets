...
from colabsnippets.face_detection.fpn.FPN3Stage_64_128_256_Tiny import FPN3Stage_64_128_256_Tiny
from test.utils import create_fake_input_tensor, test_net_save_load_forward


class Test_FPN3Stage_64_128_256_Tiny(unittest.TestCase):

  def test_FPN3Stage_64_128_256_Tiny(self):
    net = FPN3Stage_64_128_256_Tiny()
