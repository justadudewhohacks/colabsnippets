...
from colabsnippets.face_detection.fpn.FPN3Stage_128_256_512 import FPN3Stage_128_256_512
from test.utils import create_fake_input_tensor, test_net_save_load_forward


class Test_test_FPN3Stage_128_256_512(unittest.TestCase):

  def test_FPN3Stage_128_256_512(self):
    net = FPN3Stage_128_256_512()
