...
from colabsnippets.face_detection.fpn.FPN3Stagev2_128_256_512 import FPN3Stagev2_128_256_512
from test.utils import create_fake_input_tensor, test_net_save_load_forward


class Test_FPN3Stagev2_128_256_512(unittest.TestCase):

  def test_FPN3Stagev2_128_256_512(self):
    net = FPN3Stagev2_128_256_512()
  ...
  def test_save_load_forward_no_bn(self):
    net = FPN3Stagev2_128_256_512(with_batch_norm=False)
    forward = lambda: net.forward(create_fake_input_tensor(224), 1, 224)
    test_net_save_load_forward(net, forward)
