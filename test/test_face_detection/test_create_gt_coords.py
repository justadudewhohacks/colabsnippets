...
class Test_create_gt_coords(unittest.TestCase):
  ...
  def test_create_gt_coords_single_anchor(self):
    ...
    expected_gt_coords[0, 0, 0, 0, :] = [0, 0, math.log(1), math.log(1)]
    expected_gt_coords[0, 0, 9, 0, :] = [0, 0, math.log(0.5), math.log(2)]
    expected_gt_coords[0, 1, 1, 0, :] = [0.1, 0.1, math.log(1), math.log(1)]
    expected_gt_coords[0, 4, 5, 0, :] = [0.3, 0.2, math.log(0.9), math.log(1.2)]
